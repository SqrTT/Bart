        ...
        if (regexPattern.test(cartridgeName)) {
            ...
            if (cartridgePath.length) {
                ...
                try {
                        ...
                        if (result) {
                            this.newCartridgePanel.hide();
                            const panelItem = this.newCartridgePanel.getItem();
                            panelItem.getElementsByClassName('bart-cartridgename')[0].getModel().setText('');
                            panelItem.getElementsByClassName('bart-cartridgepath')[0].getModel().setText('');
                            ...
                            if(options.uploadaftercreate) {
                                ...
                                webdav.uploadCartridges(completeCartridgePath, notify);
                            }
                        }
                        else {
