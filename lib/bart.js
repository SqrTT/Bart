...
const Bart = {
    ...
    initRepo : () => {
        repo = repo || atom.project.getRepositories()[0];
        if (!repo) {
            return;
        }
        var currentBranch = repo.getShortHead();
